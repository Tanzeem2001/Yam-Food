  ...
  return (
    <div>
      ...
      <div className='container m-auto mt-5 table-responsive  table-responsive-sm table-responsive-md' >
        <table className='table bg-hover '>
...
//     try {
//       const response = await fetch("http://localhost:8000/api/auth/orderData", {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
//         },
...
//                 <td>{food.price}</td>
//                 <td>
//                   <button type="button" className="btn btn-danger text-white p-0">
